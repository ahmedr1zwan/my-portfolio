...
export const BackgroundGradientAnimation = ({
  ...
  return (
    <div
        ...
        "max-w-full"  // ✅ Ensures it doesn’t exceed the viewport width
      )}
    >
      {/* Welcome Text Layer - Does not interfere with the animation */}
      ...
      {/* Animated Background (Ensuring it stays unchanged) */}
      <div
        className={cn(
